      ...
      <div className="booking-grid">
        <div className="booking-form-container">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group"><label>Program</label><select name="program" value={formData.program} onChange={handleChange} required>
        ...
        <div className="booking-info">
          <div className="payment-info">
            ...
            <p style={{ marginTop: '1rem' }}>You will receive confirmation, travel details, and preparation guidance.</p>
          </div>
        </div>
      </div>
    </div>
